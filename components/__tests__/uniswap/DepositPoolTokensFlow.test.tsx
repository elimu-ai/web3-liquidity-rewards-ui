...
import DepositPoolTokensFlow from '../../uniswap/DepositPoolTokensFlow'
...
describe('DepositPoolTokensFlow (Uniswap)', () => {
  beforeEach(() => {
  ...
  it('disables deposit when balance is zero (insufficient balance)', () => {
    ...
    const depositButton = screen.getByRole('button', { name: /deposit \$uni-v2 pool tokens/i })
  ...
  it('renders approve flow when allowance is below requested amount', () => {
    ...
    const approveButton = screen.getByRole('button', { name: /approve \$uni-v2 allowance/i })
  ...
  it('prevents double submission once pending', () => {
    ...
    const pendingButton = screen.getByRole('button', { name: /deposit \$uni-v2 pool tokens/i })
