        ...
        <div className="flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full">
          <div className="bg-white mt-6 border w-96 rounded-2xl drop-shadow-md">
            <div className='p-6'>
              ...
              <p className='mt-4'>Deposit your Balancer pool tokens into the elimu.ai rewards <a className="font-bold text-purple-600" target="_blank" rel="noreferrer" href="https://etherscan.io/address/0x8a1d0924bb0d9b4aab6508263828ca26ca0dc235#code">smart contract</a> to start earning rewards.</p>
              <div className='mt-4'>
